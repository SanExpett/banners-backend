...
var (
	ErrAuthHeaderNotPresented = myerrors.NewError("Должен быть выставлен Authorization header, а его нет")
	ErrNotAdmin               = myerrors.NewError("Это действие может выполнять только администратор")
)
